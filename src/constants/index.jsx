...
export const RaceBikes = [
    ...
    // },
    {
        ...
        "type": < > <span className="me-2"><i className="fas fa-road"></i></span>
        Aero Road < />,
        "price": "4,700",
        ...
        "priceRange": ( < > { dollar } 4, 000 - 6, 000 < />),
		 ...
		 cyclists or moving cargo.`
                                                                                                    ...
                                                                                                    "forList": [{
                                                                                                        ...
                                                                                                        },
                                                                                                        {
                                                                                                            "listText": ( <
                                                                                                                ...
                                                                                                                who want to
                                                                                                                try multiple bike generes(road, gravel, mountain) <
                                                                                                                />
                                                                                                            ),
                                                                                                            "icons": [
                                                                                                                binoculars,
				...
				gravel, but mountain biking scares him.`
                                                                                                            ...
                                                                                                            "socials": [{
                                                                                                                    "listText": < > Strava & #8212; <a href= "https://www.strava.com/athletes/24708059"
                                                                                                                    className = "link-primary"
                                                                                                                    target = "_blank" > @colinsteidtmann < /a></ > ,
                                                                                                                    "icons": [
                                                                                                                        strava,
                                                                                                                    ],
                                                                                                                },
                                                                                                                {
                                                                                                                    "listText": < > Facebook & #8212; <a href= "https://www.facebook.com/colinsteidtmann"
                                                                                                                    className = "link-primary"
                                                                                                                    target = "_blank" > @colinsteidtmann < /a></ > ,
                                                                                                                    "icons": [
                                                                                                                        facebook,
