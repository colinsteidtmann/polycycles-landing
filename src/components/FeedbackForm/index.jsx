...
export const FeedbackForm = () => {
    return (
        <React.Fragment>
			...
			<div className="card p-3 w-100 bg-warning d-lg-none">
				<p>
					Please fill out our feedback form, we need it to validate our business model
				</p>
				<a href="https://forms.gle/WwU6kV7RfGMik88h9" target="_blank" rel="noreferrer" className="btn btn-primary mx-auto">Form is here</a>
			</div>
			...
			<a href="https://forms.gle/WwU6kV7RfGMik88h9" target="_blank" rel="noreferrer" className="text-primary float-start my-3 d-none d-lg-block">
